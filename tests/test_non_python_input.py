...
def test_non_python_source_is_safe_and_returns_valid_ranges(source: str):
    """
    Contract for unsupported / unknown languages:

    - fold() must never crash
    - returned ranges (if any) must be structurally valid
